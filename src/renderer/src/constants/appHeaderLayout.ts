...
export const HEADER_COMPACT_FONT_BREAKPOINT = 1030;
/** 窗口宽度低于此值时，转换/格式组也收入「更多」菜单 */
export const HEADER_COMPACT_FORMAT_BREAKPOINT = 830;

/** 找书在线阅读器工具栏按钮较少，收纳断点可更小 */
export const FIND_BOOK_READER_COMPACT_FONT_BREAKPOINT = 855;
export const FIND_BOOK_READER_COMPACT_FORMAT_BREAKPOINT = 655;
